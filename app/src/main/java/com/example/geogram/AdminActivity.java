...
import com.example.geogram.fcm.Data;
import com.example.geogram.fcm.FirebaseCloudMessage;
import com.example.geogram.utility.FCM;
import com.example.geogram.utility.VerticalSpacingDecorator;
...
public class AdminActivity extends AppCompatActivity {
        ...
        mSendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isEmpty(message) && !isEmpty(title)){
                    ...
                    Toast.makeText(getApplicationContext(), "Fill out the title and message fields", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void sendMessageToDepartment(String title, String message){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .addConverterFactory(GsonConverterFactory.create())//convert the data into json data
                .build();
        ...
        for(String token : mTokens){
            ...
            //firebaseCloudMessage.setTo("/topics/TEST_TOPIC");
    ...
    public void setDepartmentDialog(final User user){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext());
        builder.setIcon(R.drawable.ic_heart_white);
        ...
        final ListAdapter adapter = new ArrayAdapter<String>(getApplicationContext(),
        ...
        builder.setSingleChoiceItems(adapter, index, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(getApplicationContext(), "Department Saved", Toast.LENGTH_SHORT).show();
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
    ...
    private void setupEmployeeList(){
        ...
        mEmployeeAdapter = new EmployeesAdapter(getApplicationContext(), mUsers);
