...
public class CommentListAdapter extends ArrayAdapter<Comment> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        /**
         *  get the user id and set the query of users node
         *  inside our comment list adapter to get the user
         *  name and users profile image to display in the comment section
         */
        ...
        try{
            //position is very first position then we will
            // change the visibility of likes
    ...
    /**
     * Return a string responding the number of days ago the post was made
     * @return
     */
