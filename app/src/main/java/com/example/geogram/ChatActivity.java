...
import com.example.geogram.utility.ChatroomListAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void setupChatroomList() {
        ...
        mAdapter = new ChatroomListAdapter(this, R.layout.layout_chatroom_listitem, mChatrooms);
                ...
                for(DataSnapshot singleSnapshot:  dataSnapshot.getChildren()){
                    ...
                    if(objectMap.get(getString(R.string.field_chatroom_id)).toString()
                        ...
                        if(mSecurityLevel >= Integer.parseInt(chatroom.getSecurity_level())){
                            ...
                            Toast.makeText(getApplicationContext(), "insufficient security level", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    }
                }
...
//                            + singleSnapshot.getValue());
                    try{
                        if(singleSnapshot.exists()){
                            ...
                            /**
                             * firebase store data in the database by hashmap
                             * for this reason we create a Map object and store the
                             * data by the map object
                             */
                            ...
                            /**
                             * because of pushing the messages by hashmap
                             * we cannot retrive the messages by singleSnapshot
                             */
